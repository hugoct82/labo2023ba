...
archivo_salida <- "./exp/HT2020/gridsearch_07_bin_mod.txt"
...
for (vmax_depth in c(6,7,8)) {
  for (vmin_split in c(150,250,400,550,700)) {
    for (minbucket in c(10,40,90,150,300,450,600,800)){
      for (cp_test in c(-1,-0.05)) {
...
dir.create("./exp/", showWarnings = FALSE)
dir.create("./exp/HT2020/", showWarnings = FALSE)
archivo_salida <- "./exp/HT2020/gridsearch_bin_mod.txt"
