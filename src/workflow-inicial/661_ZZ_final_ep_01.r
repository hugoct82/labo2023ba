...
PARAM <- list()
PARAM$experimento <- "ZZ6610_ep_01"
PARAM$exp_input <- "HT6510_ep_01"
...
PARAM$modelos_rank <- c(1) #Se le ingresa como 1 , y se pueden indicar varios 1,2,3

#Cuando se hagan pruebas finales se podrá usar mas o menos semillas.
# reemplazar por las propias semillas
PARAM$semillas <- c(100019, 100043, 100049, 100057, 100069, 106791 , 157991, 203663, 300177,565057,
 124541, 420551, 589753, 565057, 591067, 632363, 689987, 770437, 810401, 989581 )
...
## ------MODIFICACIÓN PARA DETECCIÓN DE B+1 y B+2----##
dataset[, clase01 := ifelse(clase_ternaria == "BAJA+1", 0L, ifelse(clase_ternaria == "BAJA+2", 1L, NA_integer_))]
