...
PARAM <- list()
PARAM$experimento <- 321008 #cambiar por SU numero de experimento

# Establezco la semilla aleatoria, cambiar por SU primer semilla
PARAM$semilla <- 420551
...
#Esto significa que estamos excluyendo la columna "clase_ternaria" de la selección.
