...
PARAM$trainingstrategy$semilla_azar <- 420551 # Aqui poner su  primer  semilla
...
PARAM$hyperparametertuning$semilla_azar <- 589753
#------------------------------------------------------------------------------
...
hs <- makeParamSet(
  ...
  makeIntegerParam("envios", lower = 5000L, upper = 15000L) #ATENCION QUE SE PRUEBA desde 5k a 15k
)
