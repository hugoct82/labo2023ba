...
PARAM$finalmodel$num_iterations <- 595
PARAM$finalmodel$learning_rate <- 0.0100228773687415
PARAM$finalmodel$feature_fraction <- 0.623601434152323
PARAM$finalmodel$min_data_in_leaf <- 858
...
#SE CAMBIA LA SECUENCIA DE ENVIOS, 6000 A 15000

cortes <- seq(6000, 15000, by = 500)
