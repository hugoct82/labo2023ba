...
PARAM <- list()
PARAM$experimento <- "TS6410_EC_09"

PARAM$exp_input <- "FE6310_EC_09"
...
PARAM$final_train <- c(
  202107, 202106, 202105, 202104, 202103, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912,
...
dataset[, fold_train := 0L] # Se genera una columna lleba de ceros
dataset[
  foto_mes %in% PARAM$train$training &
