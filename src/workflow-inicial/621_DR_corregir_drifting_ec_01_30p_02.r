...
#Datos canasta basica
  ...
  dataset[, environmental_rate := mtotal_income / Hogar_tipo_1b ]  #44
  ...
  dataset[, ratio_deuda_capital  := mtotal_debt / ( mtotal_investment + mtotal_income)] #51

  dataset[, ratio_deuda_capital  := mtotal_debt / ( mtotal_investment + mtotal_income)] #52

  dataset[, ratio_monto_atm_atm_other  := matm/(matm + matm_other)] #53

  dataset[, ratio_mov_atm_atm_other  := catm_trx/(catm_trx+catm_trx_other)] #54
