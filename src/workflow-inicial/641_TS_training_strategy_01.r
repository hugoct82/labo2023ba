...
PARAM$train$training <- c(
  202105, 202104, 202103, 202102, 202101, 202012,
    202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910,
...
PARAM$train$undersampling <- 0.3 # esto s epuede probar para deducir el tiempo de entrenamiento
